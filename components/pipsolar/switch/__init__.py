...
CONF_LCD_DEFAULT = "lcd_default"
CONF_OVERLOAD_RESTART = "overload_restart"
CONF_OVER_TEMPERATURE = "over_temperature"
CONF_ALARM = "alarm_primary_interrupt"
CONF_FAULT_CODE = "fault_record"
...
TYPES = {
    ...
    CONF_LCD_DEFAULT: ("PEk", "PDk"),
    CONF_OVERLOAD_RESTART: ("PEu", "PDu"),
    CONF_OVER_TEMPERATURE: ("PEv", "PDv"),
    CONF_ALARM: ("PEy", "PDy"),
    CONF_FAULT_CODE: ("PEz", "PDz"),
